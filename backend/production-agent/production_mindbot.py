...
from supabase_client import supabase_client, User, VoiceSession
...
class ProductionMindBotAgent(Agent):
    ...
    def __init__(self):
        ...
        # Configuration
        self.low_balance_threshold = int(os.getenv("LOW_BALANCE_THRESHOLD_MINUTES", "30"))
        self.max_session_minutes = int(os.getenv("SESSION_TIMEOUT_MINUTES", "30"))
...
if __name__ == "__main__":
    ...
    logger.info("Starting production MindBot with Supabase and Stripe integration...")
